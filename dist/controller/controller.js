...
var signUp = function (req, res, _next) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            User_1.User.toCompare(password, existUser.password),
          ];
        case 2:
...
var googleOAuth = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
    var _a,
      email,
      username,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            Favorite_1.Favorite.addFavorite(favoriteCredentials),
          ];
        case 1:
          newFavorite = _a.sent();
          if (!newFavorite) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            Favorite_1.Favorite.findOne({ user: req.currentUser.id }),
          ];
        case 1:
          userFavories = _a.sent();
          res.send(
            userFavories === null || userFavories === void 0
              ? void 0
              : userFavories.repo
          );
          return [2 /*return*/];
...
var removeFavorites = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            Favorite_1.Favorite.deleteFavorite(req.currentUser.id, favoriteId),
          ];
        case 1:
          favorite = _a.sent();
          if (!favorite) {
